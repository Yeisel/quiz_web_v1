	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
						...
						<tr height="25" align="center">
							<td style="text-align: left">
								<div class="6u$ 12u$(small)">
									<input type="checkbox"
										id="select${list.f_board_number}" name="select">
									<label for="select${list.f_board_number}"></label>
								</div>
							</td>
							<td style="text-align: left">${list.f_board_number}</td>
							<td style="text-align: left"><a href="board_read.jsp?idx=${list.f_board_number}">${list.subject}</a></td>
							<td style="text-align: left">${list.f_board_id}</td>
							<td style="text-align: left">${list.f_board_count}</td>
							<td style="text-align: left">${list.f_board_date}</td>
							<td style="text-align: left">${list.f_board_good}</td>
						</tr>
				...
				</span> <!-- Buttons --> <span style="float: right"> <a href="#"
